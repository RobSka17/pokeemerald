...
const u8 gText_BirchBoy[] = _("STYLE 1");
const u8 gText_BirchGirl[] = _("STYLE 2");
...
const u8 gText_Birch_PeopleCallMe[] = _("People call me the POKéMON PROFESSOR.\pThat's because I'm a professor of,\nyou guessed it...”{PAUSE 96}\pPOKéMON!\p");
