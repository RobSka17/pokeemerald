...
extern const u8 gText_Birch_IncomingCall[];
extern const u8 gText_Birch_CanYouHearMe[];
extern const u8 gText_Birch_AhHello[];
extern const u8 gText_Birch_YourDad[];
extern const u8 gText_Birch_PeopleCallMe[];
extern const u8 gText_Birch_MainSpeech[];
extern const u8 gText_Birch_TellMeAboutYourself[];
extern const u8 gText_Birch_WhatsYourStyle[];
extern const u8 gText_Birch_NameYouGoBy[];
extern const u8 gText_Birch_WhatsYourName[];
extern const u8 gText_Birch_PlayerThen[];
extern const u8 gText_Birch_WellPlayer[];
extern const u8 gText_Birch_CallEnded[];
